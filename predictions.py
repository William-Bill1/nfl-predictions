...
def home_page():
    ...
    # "Underdog Bets" (moneyline) and "Over/Under Bets" (totals) tabs were removed:
    # both models are disabled (no out-of-time edge). prob_underdogWon /
    # prob_overHit still ship as market-implied views on the Probabilities tab.
    pred_tab1, pred_tab2, pred_tab3, pred_tab5, pred_tab7, pred_tab8, pred_tab9 = st.tabs([
        "📊 Model Predictions",
        "🎯 Probabilities & Edges",
        "💰 Betting Performance",
        "🏈 Spread Bets",
